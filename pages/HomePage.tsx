        ...
        <div className="container mx-auto px-5 lg:px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className={`bg-brand-light p-6 rounded-lg shadow-sm text-center transition-all duration-300 hover:shadow-lg flex flex-col justify-center scroll-reveal`}>
        ...
        <div className="container mx-auto px-5 lg:px-20">
            ...
            <div className="hidden md:grid grid-cols-1 lg:grid-cols-3 gap-8">
                {masterpieces.map((masterpiece, index) => (
                    <div key={index} className={`group relative overflow-hidden rounded-lg shadow-lg h-[450px] scroll-reveal`}>
    ...
    return (
        <div className="container mx-auto px-5 lg:px-20">
            ...
            <div className="grid lg:grid-cols-5 gap-8 items-stretch">
                <div className="lg:col-span-2 flex flex-col gap-y-4">
                     {stats.map((stat, index) => (
                         <div 
                            ...
                            className={`h-28 p-4 rounded-lg border flex items-center gap-x-4 transition-all duration-300 transform hover:-translate-y-1 cursor-pointer scroll-reveal ${
                                index === activeIndex 
                ...
                <div className="lg:col-span-3 bg-white p-6 rounded-xl shadow-lg h-full flex flex-col min-h-[450px] scroll-reveal">
        ...
        <div className="container mx-auto px-5 lg:px-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {programs.map((program, index) => (
                    <div key={index} className={`bg-white rounded-lg shadow-md overflow-hidden flex flex-col transition-all duration-300 hover:shadow-xl hover:-translate-y-1 scroll-reveal`}>
