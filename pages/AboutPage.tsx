...
const AboutPage: React.FC = () => {
  ...
  // Updated configuration for About Page Hero with construction themed slides
  const aboutSlides = [
    {
    ...
    {
        img: 'https://images.pexels.com/photos/534220/pexels-photo-534220.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
