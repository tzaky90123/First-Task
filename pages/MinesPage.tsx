...
const TechnologySection: React.FC = () => {
    const { t } = useLocalization();
    return (
        <div className="relative container mx-auto px-6 py-20 rounded-2xl overflow-hidden scroll-reveal">
...
const TestimonialsSection: React.FC = () => {
    const { t } = useLocalization();
    return (
        <div className="container mx-auto px-6 max-w-3xl text-center scroll-reveal">
