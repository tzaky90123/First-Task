        ...
        <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {benefits.map((benefit, index) => (
                    <div key={benefit.titleKey} className={`bg-white p-8 rounded-xl shadow-soft text-center transition-all duration-300 group hover:shadow-2xl hover:-translate-y-2 flex flex-col scroll-reveal`}>
        ...
        <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                {testimonials.map((item, index) => (
                     <div key={item.nameKey} className={`bg-white rounded-xl shadow-lg overflow-hidden scroll-reveal`}>
                        <div className="p-8">
...
const CareerOpportunitiesSection: React.FC = () => {
    ...
    return (
        <div className="container mx-auto px-6 text-center">
            ...
            {roles.length > 0 ? (
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 text-left mb-12">
                    {roles.map((role, index) => (
                        <div key={index} className={`bg-white p-6 rounded-lg shadow-soft border-l-4 border-brand-primary scroll-reveal`}>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 scroll-reveal">
