...
export const content: LocalizedContent = {
  ...
  btpApproachImageAlt: { [Language.FR]: "Collaboration et travail d'équipe", [Language.EN]: "Collaboration and teamwork" },
  ...
  reIntroImageAlt: { [Language.FR]: "Maison à l'architecture moderne", [Language.EN]: "Modern architectural home" },
  ...
  reSustainabilityImageAlt: { [Language.FR]: "Bâtiment éco-responsable", [Language.EN]: "Eco-friendly building" },
  ...
  reMarketImageAlt: { [Language.FR]: "Intérieur de maison moderne", [Language.EN]: "Modern interior design" },
  ...
  minesIntroParagraph2: { [Language.FR]: "Nous nous engageons à une exploitation qui respecte à la fois <strong>l'environnement et les communautés locales</strong>, en créant une valeur durable pour le Sénégal.", [Language.EN]: "We are committed to an operation that respects both <strong>the environment and local communities</strong>, creating sustainable value for Senegal." },
  minesIntroImageAlt: { [Language.FR]: "Chantier de construction moderne", [Language.EN]: "Modern construction site" },
  ...
  minesSafetyImageAlt: { [Language.FR]: "Réhabilitation de l'environnement", [Language.EN]: "Environmental reclamation" },
  ...
  careersWhyJoinImageAlt: { [Language.FR]: "Une équipe diversifiée collaborant sur un projet chez SOCABEG", [Language.EN]: "A diverse team collaborating on a project at SOCABEG" },
  ...
  careersBenefitsNewHeadline: { [Language.FR]: 'Croissance et Avantages pour les Employés', [Language.EN]: 'Employee Growth & Benefits' },
  careersBenefitsNewIntro: { [Language.FR]: 'Nous investissons dans nos collaborateurs par le développement, le bien-être et des opportunités enrichissantes.', [Language.EN]: 'We invest in our people through development, wellness, and rewarding opportunities.' },
  ...
  careersOpeningsSubheadline: { [Language.FR]: 'REJOIGNEZ NOTRE ÉQUIPE', [Language.EN]: 'JOIN OUR TEAM' },
  careersOpeningsTitle: { [Language.FR]: 'Opportunités de Carrière chez SOCABEG', [Language.EN]: 'Career Opportunities at SOCABEG' },
  careersOpeningsText: { [Language.FR]: 'Découvrez les postes à pourvoir et rejoignez notre équipe de professionnels dévoués.', [Language.EN]: 'Explore current openings and join our dedicated team of professionals.' },
  ...
  careersRole1Title: { [Language.FR]: 'Ingénieur de Chantier', [Language.EN]: 'Site Engineer' },
  careersRole1Desc: { [Language.FR]: 'Superviser les activités quotidiennes de construction, en veillant à ce que les projets soient terminés dans les délais et conformément aux spécifications.', [Language.EN]: 'Supervise daily construction activities, ensuring projects are completed on schedule and to specification.' },
  careersRole2Title: { [Language.FR]: 'Chef de Projet', [Language.EN]: 'Project Manager' },
  careersRole2Desc: { [Language.FR]: 'Diriger les projets de la conception à l\'achèvement, en gérant les budgets, les calendriers et la communication avec les parties prenantes.', [Language.EN]: 'Lead projects from conception to completion, managing budgets, schedules, and stakeholder communication.' },
  careersRole3Title: { [Language.FR]: 'Architecte', [Language.EN]: 'Architect' },
  careersRole3Desc: { [Language.FR]: 'Concevoir des structures innovantes et fonctionnelles qui répondent aux besoins des clients et respectent les codes du bâtiment.', [Language.EN]: 'Design innovative and functional structures that meet client needs and adhere to building codes.' },
  careersRole4Title: { [Language.FR]: 'Responsable Sécurité', [Language.EN]: 'Safety Officer' },
  careersRole4Desc: { [Language.FR]: 'Mettre en œuvre et surveiller les protocoles de sécurité sur le site pour garantir un environnement de travail sûr pour tout le personnel.', [Language.EN]: 'Implement and monitor safety protocols on-site to ensure a secure working environment for all personnel.' },
  ...
  contactMapTitle: { [Language.FR]: "Emplacement de SOCABEG à Dakar", [Language.EN]: "SOCABEG Location Dakar" },
  ...
  // Footer
  footerDescription: { [Language.FR]: 'Bâtir l\'avenir du Sénégal depuis 1986, avec intégrité et excellence.', [Language.EN]: 'Building the future of Senegal since 1986, with integrity and excellence.' },
  ...
  ariaLinkedin: { [Language.FR]: 'Lien vers notre page Linkedin', [Language.EN]: 'Link to our Linkedin page' },
