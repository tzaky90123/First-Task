...
export const content: LocalizedContent = {
  ...
  partnersSectionHeadline: { [Language.FR]: 'ILS NOUS FONT CONFIANCE', [Language.EN]: 'THEY TRUST US' },

  masterpieceBtpTitle: { [Language.FR]: 'BTP et Construction', [Language.EN]: 'Construction (BTP)' },
  masterpieceBtpDesc: { [Language.FR]: 'Grands projets d\'infrastructures', [Language.EN]: 'Major infrastructure projects' },
  masterpieceReTitle: { [Language.FR]: 'Promotion Immobilière', [Language.EN]: 'Real Estate Development' },
  masterpieceReDesc: { [Language.FR]: 'Espaces de vie modernes', [Language.EN]: 'Modern living spaces' },
  masterpieceMinesTitle: { [Language.FR]: 'Mines', [Language.EN]: 'Mining' },
  masterpieceMinesDesc: { [Language.FR]: 'Exploitation responsable', [Language.EN]: 'Responsible mining' },
  homeMasterpiecesTitle: { [Language.FR]: 'Nos Réalisations', [Language.EN]: 'Our Masterpieces' },
  homeMasterpiecesSubtitle: { [Language.FR]: 'PROJETS EMBLÉMATIQUES', [Language.EN]: 'ICONIC PROJECTS' },
  ...
  program1Type: { [Language.FR]: 'Résidentiel / Villa', [Language.EN]: 'Residential / Villa' },
  program1Bedrooms: { [Language.FR]: '4 Chambres', [Language.EN]: '4 Bedrooms' },
  program1Bathrooms: { [Language.FR]: '3 Salles de bain', [Language.EN]: '3 Bathrooms' },
  ...
  program1Price: { [Language.FR]: 'À partir de 45 000 000 FCFA', [Language.EN]: 'From 45,000,000 FCFA' },
  ...
  program2Bathrooms: { [Language.FR]: '2 Salles de bain', [Language.EN]: '2 Bathrooms' },
  program2Area: { [Language.FR]: '120 m²', [Language.EN]: '120 m²' },
  program2Location: { [Language.FR]: 'Dakar Centre', [Language.EN]: 'Dakar Centre' },
  ...
  program2Price: { [Language.FR]: 'À partir de 30 000 000 FCFA', [Language.EN]: 'From 30,000,000 FCFA' },

  program3Title: { [Language.FR]: 'Le Lac Rose', [Language.EN]: 'The Pink Lake' },
  program3Type: { [Language.FR]: 'Terrain Viabilisé', [Language.EN]: 'Serviced Land' },
  ...
  program3Price: { [Language.FR]: 'À partir de 12 000 000 FCFA', [Language.EN]: 'From 12,000,000 FCFA' },

  programsSectionTitle: { [Language.FR]: 'Nos Programmes', [Language.EN]: 'Our Programs' },
  programsSectionHeadline: { [Language.FR]: 'OPPORTUNITÉS IMMOBILIÈRES', [Language.EN]: 'REAL ESTATE OPPORTUNITIES' },
  programDetailsButton: { [Language.FR]: 'Voir Détails', [Language.EN]: 'View Details' },
  ...
  contactInfoTitle: { [Language.FR]: 'Nos Coordonnées', [Language.EN]: 'Contact Info' },
  ...
  contactMapTitle: { [Language.FR]: 'Carte de localisation SOCABEG', [Language.EN]: 'SOCABEG Location Map' },
  contactFormSuccess: { [Language.FR]: 'Votre message a été envoyé avec succès !', [Language.EN]: 'Your message has been sent successfully!' },
  ...
  // About Page
  aboutHeroTitle: { [Language.FR]: 'À Propos de SOCABEG', [Language.EN]: 'About SOCABEG' },
  ...
  // Real Estate Page
  reHeroTitle: { [Language.FR]: 'Promotion Immobilière', [Language.EN]: 'Real Estate Development' },
  ...
  reIntroTitle: { [Language.FR]: 'Shaping Exceptional Living and Working Spaces', [Language.EN]: 'Shaping Exceptional Living and Working Spaces' },
  ...
  reIntroFeature1Title: { [Language.FR]: 'Innovative Design', [Language.EN]: 'Innovative Design' },
  ...
  reIntroFeature2Title: { [Language.FR]: 'Superior Functionality', [Language.EN]: 'Superior Functionality' },
  reIntroFeature2Desc: { [Language.FR]: 'Spaces optimized for comfort, productivity, and a modern lifestyle.', [Language.EN]: 'Spaces optimized for comfort, productivity, and a modern lifestyle.' },
  reIntroFeature3Title: { [Language.FR]: 'Harmonious Integration', [Language.EN]: 'Harmonious Integration' },
  reIntroFeature3Desc: { [Language.FR]: 'Projects that respect and enhance their natural and urban surroundings.', [Language.EN]: 'Projects that respect and enhance their natural and urban surroundings.' },
  reIntroTypeResidential: { [Language.FR]: 'Residential', [Language.EN]: 'Residential' },
  reIntroTypeCommercial: { [Language.FR]: 'Commercial', [Language.EN]: 'Commercial' },
  reIntroTypeMixedUse: { [Language.FR]: 'Mixed-Use', [Language.EN]: 'Mixed-Use' },
  reIntroImageAlt: { [Language.FR]: 'Projet immobilier moderne', [Language.EN]: 'Modern real estate project' },

  rePortfolioTitle: { [Language.FR]: 'Nos Projets Phares', [Language.EN]: 'Featured Projects' },
  rePortfolioSubtitle: { [Language.FR]: 'DÉCOUVREZ NOS RÉALISATIONS', [Language.EN]: 'DISCOVER OUR ACHIEVEMENTS' },
  rePortfolioKeyFeatures: { [Language.FR]: 'Caractéristiques Clés', [Language.EN]: 'Key Features' },
  reProjectBalenaFeatures: { [Language.FR]: 'Design contemporain, Jardin privé, Sécurité 24/7', [Language.EN]: 'Contemporary design, Private garden, 24/7 Security' },
