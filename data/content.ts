...
export const content: LocalizedContent = {
  ...
  testimonial1Quote: { [Language.FR]: "SOCABEG nous a accompagnés du début à la fin du projet avec un professionnalisme exceptionnel. Leur équipe a su allier qualité, rigueur et respect des délais.", [Language.EN]: "SOCABEG supported us from the beginning to the end of the project with exceptional professionalism. Their team knew how to combine quality, rigor, and respect for deadlines." },
  testimonial1Name: { [Language.FR]: "Mamadou Diallo", [Language.EN]: "Mamadou Diallo" },
  testimonial2Quote: { [Language.FR]: "Une expérience très positive, des solutions innovantes et un suivi de chantier exemplaire. SOCABEG est un partenaire de confiance.", [Language.EN]: "A very positive experience, innovative solutions, and exemplary site monitoring. SOCABEG is a trusted partner." },
  testimonial2Name: { [Language.FR]: "Fatou Ndiaye, Architecte", [Language.EN]: "Fatou Ndiaye, Architect" },
