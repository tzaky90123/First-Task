...
export const content: LocalizedContent = {
  ...
  contactFormTitle: { [Language.FR]: 'Message', [Language.EN]: 'Message' },
  formName: { [Language.FR]: 'Nom', [Language.EN]: 'Name' },
  formEmail: { [Language.FR]: 'E-mail', [Language.EN]: 'Email' },
  formSubject: { [Language.FR]: 'Sujet', [Language.EN]: 'Subject' },
  formMessage: { [Language.FR]: 'Message', [Language.EN]: 'Message' },
  formMessagePlaceholder: { [Language.FR]: 'Votre message...', [Language.EN]: 'Your message...' },
  formSend: { [Language.FR]: 'Envoyer', [Language.EN]: 'Send' },
  contactInfoTitle: { [Language.FR]: 'Infos', [Language.EN]: 'Info' },
  ...
  btpApproachSustainabilityTitle: { [Language.FR]: 'Durabilité', [Language.EN]: 'Sustainability' },
  ...
  reIntroFeature2Title: { [Language.FR]: 'Fonctionnalité', [Language.EN]: 'Functionality' },
  ...
  reIntroFeature3Title: { [Language.FR]: 'Intégration', [Language.EN]: 'Integration' },
  ...
  minesProject2Title: { [Language.FR]: 'Matam Phosphates', [Language.EN]: 'Matam Phosphates' },
  ...
  careersBenefit1Desc: { [Language.FR]: 'Salaires compétitifs et primes basées sur la performance.', [Language.EN]: 'Competitive salary packages and performance-based bonuses.' },
  careersBenefit2Title: { [Language.FR]: 'Santé', [Language.EN]: 'Health' },
  careersBenefit2Desc: { [Language.FR]: 'Assurance médicale complète et soutien au bien-être.', [Language.EN]: 'Comprehensive medical insurance and wellness support.' },
  careersBenefit3Title: { [Language.FR]: 'Formation', [Language.EN]: 'Training' },
  careersBenefit3Desc: { [Language.FR]: 'Programmes de développement professionnel et formation continue.', [Language.EN]: 'Professional development programs and continuous training.' },
  careersBenefit4Title: { [Language.FR]: 'Mentorat', [Language.EN]: 'Mentorship' },
  careersBenefit4Desc: { [Language.FR]: 'Accompagnement personnalisé et coaching par des mentors expérimentés.', [Language.EN]: 'Personal guidance and coaching from experienced mentors.' },
  ...
  careersRole3Title: { [Language.FR]: 'Commercial', [Language.EN]: 'Sales Agent' },
